...
Route::get('/portefeuille', 'SpendController@index')->name('portefeuille')->middleware('auth');

Route::get('/portefeuille/sell/{spend}', 'SpendController@displaySpend')->name('portefeuille-sell')->middleware('auth');
...
Route::get('/historique', 'SpendController@showHistorique')->name('portefeuille')->middleware('auth');
