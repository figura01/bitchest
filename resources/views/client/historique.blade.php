...
@section('content')
    ...
    <h2 class="sub-header">Liste des transactions<span class="solde">Mon solde: <strong>{{$portefeuille->solde_euros}} €</strong></span></h2>
            ...
            <table class="table table-striped">
                ...
                @foreach($spends as $spend)
                    ...
                    <tr>
                        ...
                        <td>{{ $spend->crypto->valeur_init}}€</td>
            ...
            <table class="table table-striped">
                ...
                @foreach($achats as $achat)
                    ...
                    <tr>
                        ...
                        <td>{{ $achat->crypto->name}}</td>
                        <td>{{ $achat->quantité}}</td>
                        <td>{{ $achat->crypto->valeur_init}}€</td>
            ...
            <table class="table table-striped">
                ...
                @foreach($ventes as $vente)
                    ...
                    <tr>
                        ...
                        <td>{{ $vente->crypto->name}}</td>
                        <td>{{ $vente->quantité}}</td>
                        <td>{{ $vente->crypto->valeur_init}}€</td>
